	...
	>
		...
		<button class="remove" formaction="?/remove">
			...
			>
				...
				/>
				<path
					d="M10 18C9.44772 18 9 17.5523 9 17L9 11C9 10.4477 9.44772 10 10 10C10.5523 10 11 10.4477 11 11V17C11 17.5523 10.5523 18 10 18Z"
					fill="white"
				/>
				<path
					d="M13 17C13 17.5523 13.4477 18 14 18C14.5523 18 15 17.5523 15 17V11C15 10.4477 14.5523 10 14 10C13.4477 10 13 10.4477 13 11V17Z"
					fill="white"
				/>
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M2.25 6.5C2.25 5.94772 2.69772 5.5 3.25 5.5H20.75C21.3023 5.5 21.75 5.94772 21.75 6.5C21.75 7.05228 21.3023 7.5 20.75 7.5H20.0386L19.1968 19.2848C19.0473 21.3781 17.3055 22.9999 15.207 22.9999H8.7937C6.69515 22.9999 4.95339 21.3781 4.80387 19.2848L3.96209 7.5H3.25C2.69772 7.5 2.25 7.05228 2.25 6.5ZM5.96719 7.5H18.0335L17.2019 19.1424C17.1271 20.189 16.2563 20.9999 15.207 20.9999H8.7937C7.74443 20.9999 6.87354 20.189 6.79879 19.1424L5.96719 7.5Z"
					fill="white"
				/>
			</svg>
		</button>
...
<div id="content" style:view-transition-name={['todo', todo.id].join('-')}>
	{@render zzic(todo)}
</div>

<script>
	...
	const variantClasses = {
		primary: 'from-pink-200 to-blue-200 hover:from-pink-300 hover:to-blue-300',
		secondary: 'from-violet-200 to-pink-100 hover:from-violet-300 hover:to-pink-200',
